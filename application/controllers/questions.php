										...
										<div class="tab-pane tab_questions" id="tab<?php echo $count;?>" data-count="<?php echo $count;?>" rel="qus_<?php echo $question['qus_id'];?>">
											<div class="form-horizontal">
												<div class="form-group">
													<label class="col-lg-9 col-md-9 col-sm-9 pull-left" style="font-size:12px;font-weight:650;"><?php echo $question['qus_questions']; ?>?</label>
                        ...
                        success: function (data) {
                                    ...
                                    if (data.score_board != "") { 
                                        if(jQuery.isEmptyObject(data.score_board)){}
                                            ...
                                            var redir_loc = site_url+"course/enrolled_course/"+enroll;
